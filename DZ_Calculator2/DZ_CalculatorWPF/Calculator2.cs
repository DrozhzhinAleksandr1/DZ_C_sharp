...
namespace DZ_CalculatorWPF
{
    public partial class Calculator2 : Form
    {
        ...
        private void ClosingCalculator2(object sender, FormClosingEventArgs e)
        {
            var form = Application.OpenForms[0];
            if(_closing == true) form.Close();
        }
        ...
        {
            // добавить текст бокс и между скобками вводить его значение

            exp = '(' + textBox1.Text.Replace(" ", "") + ')';
