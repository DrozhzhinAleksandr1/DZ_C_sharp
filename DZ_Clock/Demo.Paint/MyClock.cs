...
namespace Demo.Paint
{
    public partial class MyClock : UserControl
    {
        ...
        [Browsable(true)]
        public int MyClockTimezone { get; set; } = 0;


        [Browsable(true)]
        public Color ColorArrowSec { get; set; } = Color.Red;
        [Browsable(true)]
        public Color ColorArrowMin { get; set; } = Color.Green;
        [Browsable(true)]
        public Color ColorArrowHour { get; set; } = Color.Yellow;
        ...
        private void MyClock_Paint(object sender, PaintEventArgs e)
        {
            ...
            int angle3 = (DateTime.Now.Hour + MyClockTimezone) * 30 + 270 + DateTime.Now.Minute / 2;
            ...
            Pen p2 = new Pen(ColorArrowMin, 4);
            ...
            Pen p3 = new Pen(ColorArrowHour, 4);
